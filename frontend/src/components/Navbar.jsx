...
//     <>
//       {/* -------- Desktop Navbar -------- */}
//       <div className=' w-full py-4 px-10 shadow-sm bg-white font-medium sticky top-0 z-50'>
//         {/* Logo */}
...
//       {/* -------- Mobile Navbar -------- */}
//       <div className='flex sm:hidden items-center justify-between w-full py-4 px-5 shadow-sm bg-white font-medium sticky top-0 z-50'>
